...
function format(date) {
  ...
  const month = (date.getMonth() + 1).toString().padStart(2, '0'); // Ajoute un zéro initial si le mois est inférieur à 10
  const day = date.getDate().toString().padStart(2, '0'); // Ajoute un zéro initial si le jour est inférieur à 10
